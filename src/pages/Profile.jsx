			...
			<div className='flex flex-col justify-start items-center  w-3/4'>
				<div className='grid grid-cols-2 w-2/4'>
					...
					<input
						...
						value={username}
						className=' decoration-3 text-lg   rounded-md p-2 bg-[#2E2E2F]'
					/>
				</div>
				<div className='grid grid-cols-2 w-2/4 mt-3 '>
					<h1 className='text-2xl font-serif m-2'>Email:</h1>
					<input
						className='rounded-md p-2 bg-[#2E2E2F]'
						type='email'
						placeholder='email'
						value={user?.email}
					/>
				...
				<div className='grid grid-cols-2  w-2/4 mt-3'>
					...
					<input
						className='bg-[#2E2E2F] rounded-md p-2'
						style={{
							textDecoration: 'none',
						}}
						type='text'
