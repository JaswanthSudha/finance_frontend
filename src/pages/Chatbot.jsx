...
const Chatbot = () => {
	...
	return (
		<div className='flex text-black  h-full bg-[#202021]'>
			<div
				className='p-20 overflow-hidden  w-full  '
				style={{ maxHeight: 'calc(100vh - 200px)', overflowY: 'auto' }}>
				{allMessages === undefined || allMessages?.length === 0 ? (
					<div className='text-3xl font-serif text-white '>No Recent Chats</div>
				) : (
					allMessages?.map((message) => (
						<div
							...
							{message.isUser ? (
								...
								<div
									ref={bottomRef}
									className='w-2/3 text-white width-full rounded-lg bg-gray-950'>
									<div className='p-2 '>
										<strong>
											<SmartToyIcon />
										</strong>{' '}
			...
			<form
				...
				<input
					className='border border-gray-400 w-1/2 p-2 bg-[#2E2E2F] text-white'
					style={{
						width: '80%',
						borderRadius: '10px',
						padding: '10px',
